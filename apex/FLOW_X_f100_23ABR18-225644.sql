...
--   Application:     100
--   Name:            Reportes
--   Date and Time:   22:56 Lunes Abril 23, 2018
--   Exported By:     ADMIN
--   Flashback:       0
...
,p_last_upd_yyyymmddhh24miss=>'20180423225424'
...
,p_cache_timeout_seconds=>21600
,p_last_updated_by=>'ADMIN'
,p_last_upd_yyyymmddhh24miss=>'20180423224100'
);
wwv_flow_api.create_page_plug(
...
'    ',
':P207_USUARIO := :P101_USERNAME;',
':P207_CLAVE := toolkit.encrypt(:P101_PASSWORD);  '))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_process(
...
,p_button_position=>'REGION_TEMPLATE_CLOSE'
,p_button_redirect_url=>'javascript:var myWindow = window.open(''http://192.168.0.100:8080/apex_excel/super_morosidad.jsp?usuario=''+ $v(''P207_USUARIO'')+''&clave=''+$v(''P207_CLAVE''));'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3142495640459401)
,p_name=>'P207_USUARIO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(5853857055714374)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3142531339459402)
,p_name=>'P207_CLAVE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(5853857055714374)
,p_display_as=>'NATIVE_HIDDEN'
